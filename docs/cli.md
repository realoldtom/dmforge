...
╭─ Options ─────────────────────────────────────────────────────────────────────────────────╮
│ --output                                TEXT     Output filename for the deck.            │
│                                                  [default: deck.json]                     │
│ --limit           -n                    INTEGER  Limit the number of spells.              │
│                                                  [default: None]                          │
│ --summarize           --no-summarize             Summarize spell descriptions.            │
│                                                  [default: no-summarize]                  │
│ --summary-length                        INTEGER  Max length of summary in characters.     │
│                                                  [default: 250]                           │
│ --class                                 TEXT     Comma-separated class filter (e.g.       │
│                                                  wizard,cleric).                          │
│                                                  [default: None]                          │
│ --level                                 TEXT     Comma-separated spell level(s) (e.g.     │
│                                                  1,2,3).                                  │
│                                                  [default: None]                          │
│ --school                                TEXT     Comma-separated spell school(s).         │
│                                                  [default: None]                          │
│ --interactive                                    Select specific spells interactively     │
│                                                  after filtering.                         │
│ --help                                           Show this message and exit.              │
╰───────────────────────────────────────────────────────────────────────────────────────────╯
```
...
╭─ Arguments ───────────────────────────────────────────────────────────────────────────────╮
│ *    deck_file      PATH  Path to deck JSON to enrich with art. [default: None]           │
│                           [required]                                                      │
╰───────────────────────────────────────────────────────────────────────────────────────────╯
╭─ Options ─────────────────────────────────────────────────────────────────────────────────╮
...
╰───────────────────────────────────────────────────────────────────────────────────────────╯
╭─ Options ─────────────────────────────────────────────────────────────────────────────────╮
│ --format                              TEXT     Output format (pdf or html).               │
│                                                [default: pdf]                             │
│ --layout                              TEXT     Layout: 'sheet' (6/page) or 'cards'        │
│                                                (1/page).                                  │
│                                                [default: sheet]                           │
│ --output                              TEXT     Output file path. [default: None]          │
│ --theme                               TEXT     CSS theme to apply. [default: default]     │
│ --debug                                        Also save raw HTML output.                 │
│ --summarize         --no-summarize             Summarize before rendering.                │
│                                                [default: no-summarize]                    │
